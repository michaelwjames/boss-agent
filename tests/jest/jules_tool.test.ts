...
describe('JulesTool', () => {
  ...
  it('should send output to discord and return __NO_RESPONSE_NEEDED__ to LLM when context is present', async () => {
  ...
  it('should return truncated output for LLM if too long and no context', async () => {
