 ...
 * Usage: node skills/remind.js <delay> <webhook_url> <message>
 *
...
if (!delayArg || !webhookUrl || !message) {
  console.error('Usage: node skills/remind.js <delay> <webhook_url> <message>');
  console.error('Example: node skills/remind.js 5m https://discord.com/api/webhooks/... "Check on urgent task"');
  process.exit(1);
}
